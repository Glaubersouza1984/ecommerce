...
{ // Classe model sabe fazer os geters e seters

  public static function listAll() // Só traz os dados do banco de dados como um array e não passa pelo getvalues que é onde tem o tratamento da imagem.
  {
  ...
  public static function checkList($list) // Checagem na lista de produtos uma camada para chamar o objeto chamar o get values e me trazer estes objetos tratados.
  {
